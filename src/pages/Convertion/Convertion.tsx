        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Taxas em tempo real da CoinGecko API
            </p>
          </div>
        </div>
            ...
            {result ? (
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border">
                  ...
                  <p className="text-2xl font-bold text-gray-800">
                    {formatNumber(result.fromAmount)}{" "}
                    {result.fromCurrency.symbol}
                  </p>
                  <p className="text-sm text-gray-500">
                    {result.fromCurrency.name}
                  </p>
                </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  ...
                  <p className="text-lg font-semibold text-blue-800">
                    1 {result.fromCurrency.symbol} = {formatRate(result.rate)}{" "}
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  Preencha os dados e clique em converter
                </p>
                <p className="text-sm text-gray-400 mt-2">
                  Taxas em tempo real da CoinGecko
                </p>
              </div>
            )}
          </div>
